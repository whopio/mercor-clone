      ...
      >
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Apply for Gig</h2>
            <button
              onClick={handleClose}
          ...
          <div className="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 mt-3 line-clamp-2">{listing.description}</p>
          </div>
